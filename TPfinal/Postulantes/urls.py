...
urlpatterns = [
    ...
    path('misPostulaciones', views.MisPostulaciones.as_view(),name='MisPostulaciones'),
    ...
    path(r'^mensaje/(?P<pk>\d+)/(?P<post>\d+)/$', views.MensajeCracion.as_view(), name='Mensaje'),  #Recibe dos parámetros por URL
